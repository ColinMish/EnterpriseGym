...
CREATE TABLE IF NOT EXISTS `Enterprise_Gym`.`account` (
  ...
  `salt` VARCHAR(1000) NULL COMMENT '',
...
CREATE TABLE IF NOT EXISTS `Enterprise_Gym`.`user` (
  ...
  `practice_points` INT NULL DEFAULT 0 COMMENT '',
  `virtual_points` INT NULL DEFAULT 0 COMMENT '',
  `project_points` INT NULL DEFAULT 0 COMMENT '',
  `theory_points` INT NULL DEFAULT 0 COMMENT '',
